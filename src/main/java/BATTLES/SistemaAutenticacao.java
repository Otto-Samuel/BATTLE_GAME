...
public class SistemaAutenticacao {
    ...
    public SistemaAutenticacao() {
        ...
        // Adiciona um jogador admin para testes
    ...
    // Método para carregar dados (futura implementação)
    public void carregarDados() {
        // Implementar lógica para carregar de arquivo/banco de dados
    }
    
    // Método para salvar dados (futura implementação)
    public void salvarDados() {
        // Implementar lógica para salvar em arquivo/banco de dados
    }
    ...
    public void listarJogadores() {
        ...
        for (int i = 0; i < jogadores.tamanho(); i++) {
            ...
            System.out.println((i+1) + ". " + j.getNome() + 
                             " (Personagens: " + j.getPersonagens().tamanho() + 
                             ", Moedas: " + j.getSaldoMoedas() + ")");
        }
    }
}
